...
const ProfilePage = () => {
  ...
  return (
    <div
      className={`flex min-h-screen flex-col ${theme === "dark" ? "bg-gray-800 text-white" : "bg-gray-100"}`}
    >
      {/* Profile Section */}
      ...
      <div className="-mt-6 flex flex-col rounded-t-lg bg-gray-100 text-sm dark:bg-gray-800 xs:pb-20 xs:pt-8">
        {/*  Menu Section */}
          ...
          <div className="text-gray-700 dark:text-gray-300">
            ...
            {isAccountSettingsOpen && (
              <div className="ml-8 space-y-2 text-gray-600 dark:text-gray-400">
                ...
                >
                  <span>{t("menuSection.accountSettings.information")}</span>
      ...
      {/* Footer Section */}
      <footer className="flex flex-col items-center bg-gray-100 dark:bg-gray-800 lg:mt-auto lg:py-4">
