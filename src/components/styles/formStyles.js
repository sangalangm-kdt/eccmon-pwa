...
export const formContainer = "flex min-h-screen items-center justify-center bg-secondary";
export const formWrapper = "w-full max-w-sm gap-1 rounded bg-white p-8 text-sm shadow-md";
export const headerText = "mb-6 text-center text-2xl font-bold";
export const subHeaderText = "text-gray- mb-4 text-center text-xs";
export const inputField = "w-full rounded border px-4 py-2 focus:outline-none focus:ring-1 focus:ring-primary";
